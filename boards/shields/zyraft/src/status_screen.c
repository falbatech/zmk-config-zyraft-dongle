...
static void update_bt_profile(void) {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        lv_obj_align(bt_dots[i], LV_ALIGN_BOTTOM_MID, -32 + (i * 16), -13);
    }
}
...
static void build_battery_widgets(void) {
    ...
    lv_obj_align(left_percent, LV_ALIGN_CENTER, -76, -5);
