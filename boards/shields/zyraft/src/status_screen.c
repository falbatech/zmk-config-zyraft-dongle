...
#define COLOR_BAR_LOW   0x44FF00  /* dolne segmenty — zielony (BGR: R i B zamienione) */
#define COLOR_BAR_HIGH  0x888888  /* górne segmenty — siwy (symetryczny, BGR-bezpieczny) */
